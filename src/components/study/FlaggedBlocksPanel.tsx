...
export function FlaggedBlocksPanel({ initialBlocks }: FlaggedBlocksPanelProps) {
  ...
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-5 text-slate-800 shadow-sm animate-in fade-in duration-300">
      {/* Cabeçalho do Painel */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        {selectedIds.size > 0 && (
          <button
            ...
            className="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-semibold flex items-center gap-2 shadow-sm transition-all shrink-0"
          >
        ...
        {blocks.map((block) => {
          ...
          return (
            ...
            >
              ...
              {/* Ações Individuais (3 Opções com Peso Visual Igualitário) */}
              <div className="flex items-center gap-2 shrink-0 self-end md:self-center">
                ...
                <button
                  ...
                  className="px-3.5 py-2 bg-emerald-50 hover:bg-emerald-100 active:bg-emerald-200 text-emerald-800 border border-emerald-300/80 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-2xs disabled:opacity-50"
                >
                  {isBlockLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />}
                  Já estudei
                </button>
                ...
                <button
                  ...
                  className="px-3.5 py-2 bg-amber-50 hover:bg-amber-100 active:bg-amber-200 text-amber-900 border border-amber-300/80 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-2xs disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="px-3.5 py-2 bg-sky-50 hover:bg-sky-100 active:bg-sky-200 text-sky-900 border border-sky-300/80 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-2xs disabled:opacity-50"
                >
